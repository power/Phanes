...
function jsonify($name, $par, $value){
    $a = Get-Content '.\vulns.json' -raw | ConvertFrom-Json
    ...
    $a | ConvertTo-Json -depth 32| set-content '.\vulns.json'
}
...
function badAcl {
    #.\sysinternals\psexec.exe \\comp01 powershell -Command "C:\Users\Administrator\Desktop\badacl.ps1"
    ...
    .\sysinternals\psexec.exe \\comp01 -u "FAKECOMPANY.LOCAL\Administrator" -p "Admin123!" powershell -Command "cmd /c 'copy /y \\192.168.18.149\COMP01_Files\badacl.ps1 C:\\Users\Administrator\\Desktop'" | Out-Null
    .\sysinternals\psexec.exe \\comp01 -u "FAKECOMPANY.LOCAL\Administrator" -p "Admin123!" powershell -Command "C:\Users\Administrator\Desktop\badacl.ps1" | Out-Null
...
function ntlmRelay {
    ...
    New-SmbShare @Params | Out-Null
    .\sysinternals\psexec.exe \\comp01 -u "FAKECOMPANY.LOCAL\Administrator" -p "Admin123!" powershell -Command "cmd /c 'copy /y \\192.168.18.149\COMP01_Files\ntlmrelay.ps1 C:\\Users\Administrator\\Desktop'" | Out-Null
    .\sysinternals\psexec.exe \\comp01 -u "FAKECOMPANY.LOCAL\Administrator" -p "Admin123!" powershell -Command "cmd /c 'copy /y \\192.168.18.149\COMP01_Files\sam_names.txt C:\\Users\Administrator\\Desktop'" | Out-Null
    .\sysinternals\psexec.exe \\comp01 -u "FAKECOMPANY.LOCAL\Administrator" -p "Admin123!" -s powershell -Command "C:\Users\Administrator\Desktop\ntlmrelay.ps1" | Out-Null
    Remove-SmbShare -Name "COMP01_Files" -Force | Out-Null
